class DirectorsController < ApplicationController
  ...
  def create
    director_attributes = params.require(:director).permit(:name, :profession)
  ...
  def update
    ...
    if @director.valid?
      @director.save
      redirect_to directors_url(@director), notice: "Director updated successfully"
    else
      redirect_to directors_url(@director), alert: "Director failed to update successfully."
    end
